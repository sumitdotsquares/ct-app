...
export default function ProductCard(props) {
  ...
  const description = (value, short = false) => {
    var description = "";
    if (value.staged.description) {
      description = value.staged.description.en;
      if (short) description = description.substring(0, 40) + "...";
    }
    return description;
  };
        ...
        <div style={styles.card} className="h-100" onClick={handleShow}>
          ...
          <div className="card-body" style={{ paddingBottom: 0 }}>
            ...
            <p style={{ paddingTop: "20px" }}>
              {description(props.product.masterData, true)}
            </p>
            <p>
              {displayPrice(
      ...
      <Modal show={show} centered onHide={handleClose} size="lg">
        ...
        <Modal.Body>
          <div className="row">
            ...
            <div className="col-5">
              <p>{description(props.product.masterData)}</p>
            </div>
          </div>
        </Modal.Body>
        <Modal.Footer>
